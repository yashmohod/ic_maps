...
| Section             | What it is                                                                                                                                                                                                                                                                                                                                                  |
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Shared module**   | Types (`ApiNode`, `ApiEdge`, `NodeKind`), layout constants (`BASE_GROUP_WIDTH`, edge colors), and helpers (`getEdgeStyle`, `groupNodeStyle`, `smallNodeStyle`, `NODE_KIND_META`, `apiNodeToKind`, `sortNodesParentBeforeChild`) are imported from `@/lib/floorplan-flow` — the same module used by the readonly floorplan canvas and admin report previews. |
| **Types (local)**   | `NodeData`, `AppNode`, `AppEdge`, `DestinationOption` – editor-specific UI shapes.                                                                                                                                                                                                                                                                          |
...
| **Helpers (local)** | `insertNodeWithParent`, `moveNodeAfterParent` – keep parent-before-child order for React Flow.                                                                                                                                                                                                                                                              |
